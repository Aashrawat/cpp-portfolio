...
// -----------------------------------------------------------
// Name            Date            Reason
//Aashrawat Shrestha Oct 1        For W3
/////////////////////////////////////////////////////////////////
***********************************************************************/
...
int main() {
    CC empty;
    cout << "Empty credit card record: " << endl;
    empty.display();
    CC cc("Hubert Blaine", 4098765423457896, 100);
    cout << "Valid credit card record:\n|Valid";
    cc.display();
    cout << "+-----+--------------------------------+---------------------+-----+-------+" << endl;
    cout << "Valid credit card with very long name:\n|Valid";
